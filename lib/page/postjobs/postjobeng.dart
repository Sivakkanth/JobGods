...
class Post_job_eng extends StatefulWidget {
  const Post_job_eng({super.key});

  @override
  State<Post_job_eng> createState() => _Post_job_engState();
}

class _Post_job_engState extends State<Post_job_eng> {
  @override
          ...
          children: [
            Container(
              ...
              child: Container(
                ...
                child: ClipOval(
                  child: Image.asset(
                    'image/engineer.png', // Replace with your image path
