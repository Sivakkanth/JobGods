...
class Post_job_carpenter extends StatefulWidget {
  const Post_job_carpenter({super.key});

  @override
  State<Post_job_carpenter> createState() => _Post_job_carpenterState();
}

class _Post_job_carpenterState extends State<Post_job_carpenter> {
  @override
          ...
          children: [
            Container(
              ...
              child: Container(
                ...
                child: ClipOval(
                  child: Image.asset(
                    'image/carpentor.png', // Replace with your image path
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Color(0xff0E98B6)// Change the background color here
                    ),
                    child: Text(
                      'Post',
                      style: TextStyle(
