...
class Post_job_mevhanic extends StatefulWidget {
  const Post_job_mevhanic({super.key});

  @override
  State<Post_job_mevhanic> createState() => _Post_job_mevhanicState();
}

class _Post_job_mevhanicState extends State<Post_job_mevhanic> {
  @override
          ...
          children: [
            Container(
              ...
              child: Container(
                ...
                child: ClipOval(
                  child: Image.asset(
                    'image/mechanic.jpeg', // Replace with your image path
