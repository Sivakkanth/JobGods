...
class Post_job_plumber extends StatefulWidget {
  const Post_job_plumber({super.key});

  @override
  State<Post_job_plumber> createState() => _Post_job_plumberState();
}

class _Post_job_plumberState extends State<Post_job_plumber> {
  @override
          ...
          children: [
            Container(
              ...
              child: Container(
                ...
                child: ClipOval(
                  child: Image.asset(
                    'image/plumber.png', // Replace with your image path
